...
class TestCall(TestCase):
    ...
    def test_call_2(self):
        ...
        f.assert_called_once_with(e, self, 1)
    
    def test_call_3(self):
        self._call_3(1, 2, 3)

        f.assert_called_once_with(e, self, 1, 2, 3)
    
    def test_call_4(self):
        self._call_4(a=1)

        f.assert_called_once_with(e, self, a=1)
    
    def test_call_5(self):
        self._call_5(a=1, b=2, c=3)

        f.assert_called_once_with(e, self, a=1, b=2, c=3)
    
    def test_call_6(self):
        self._call_6(1, b=2)

        f.assert_called_once_with(e, self, 1, b=2)
